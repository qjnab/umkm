...
if ($bulan[1]>3 && $bulan[0] == 2021) {
 ...
 ?>
 <a href="print_laporan_penjualan.php?mulai=<?php echo($_GET['mulai']) ?>&selesai=<?php echo $_GET['selesai'] ?>" role="button">Cetak</a>
...
<table width="100%" style="border: none">
	...
	<tr style="border: none">
		...
		<td style="border: none">&nbsp</td>
		<td style="border: none"></td>
		<td colspan="2" align="center" style="border: none">Surabaya,&nbsp&nbsp&nbsp&nbsp<?php echo $namaBulan[$b-1]." ".$bulan[0];?></td>
	</tr>
	<tr style="border: none">
		<td style="border: none">&nbsp</td>
		<td align="center" style="border: none"></td>
		<td style="border: none"></td>
		<td colspan="2" align="center" style="border: none">Mengetahui,</td>
	</tr>
	<tr>
		<td style="border: none">&nbsp</td>
		<td align="center" style="border: none"></td>
		<td style="border: none"></td>
		<td colspan="2" align="center" style="border: none">Seksi Keamanan Pangan,</td>
	</tr>
	<tr>
		<td style="border: none">&nbsp</td>
		<td style="border: none">&nbsp</td>
	...
	<tr>
		...
		<td style="border: none">&nbsp</td>
		<td colspan="2" align="center" style="text-decoration:underline;border: none">Drh. Rinni Sulestari</td>
	</tr>
	<tr>
		<td style="border: none">&nbsp</td>
		<td  style="border: none" align="center"></td>
		<td style="border: none"></td>
		<td colspan="2"  style="border: none" align="center">NIP 196909241997032005</td>
	</tr>
</table>